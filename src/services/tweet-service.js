const { TweetRepository, hashtagRepository, HashtagRepository } = require('../repository/index');
...
class TweetService {
    ...
    async create(data) {
        ...
        const tags = content.match(/#[a-zA-Z0-9_]+/g).map((tag) => tag.substring(1)); // this extracts hashtags
        // console.log(tags);
